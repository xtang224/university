...
<html:html locale="true">
  ...
  <body bgcolor="white"><p>   
   ...
   <html:errors/><p> 
    ...
    <logic:present name="fillquadblankbean" scope="request">
       <h2>
         <bean:message key="hello.jsp.page.solution"/>
         <bean:write name="fillquadblankbean" property="statement_1st" />         
         <bean:write name="fillquadblankbean" property="solution_1st" />    
         <bean:write name="fillquadblankbean" property="statement_2nd" />
         <bean:write name="fillquadblankbean" property="solution_2nd" />    
         <bean:write name="fillquadblankbean" property="statement_3rd" />
         <bean:write name="fillquadblankbean" property="solution_3rd" />    
         <bean:write name="fillquadblankbean" property="statement_4th" />
         <bean:write name="fillquadblankbean" property="solution_4th" />    
         <bean:write name="fillquadblankbean" property="statement_5th" /><P> 
       </h2>
    </logic:present>
  ...
  <!--   <bean:message key="hello.jsp.page.lastCorrect"/>
    ...
    <% session = request.getSession(true);     
       ...
       session.setAttribute(hello.Constants.FILLQUADBLANK_KEY, _fqbb);
